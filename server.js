...
// Recipe Extraction API - No Database Version
...
async function extractRecipeFromCaption(caption, thumbnailUrl, sourceUrl) {
  const prompt = `Extract a recipe from this TikTok caption. Return ONLY valid JSON:
...
// TEST ENDPOINT - Test Claude without TikTok
